...
p = getInnerPnt(f1, p6)
# print p.__dict__
f1_ch = faceFactory(f1.p1, f1.p2, f1.p3, p)
f2_ch = faceFactory(f2.p1, f2.p2, f2.p3, p)
f3_ch = faceFactory(f3.p1, f3.p2, f3.p3, p)
f4_ch = faceFactory(f4.p1, f4.p2, f4.p3, p)
# print f1.__dict__
# print f1_ch.__dict__


print checkVisibility(f1, p)
print checkVisibility(f1_ch, p)
print checkVisibility(f2, p)
print checkVisibility(f2_ch, p)
print checkVisibility(f2_ch, p9)
print checkVisibility(f4, p)
print checkVisibility(f4_ch, p)
print checkVisibility(f4_ch, p9)
print checkVisibility(f1, p9)
print checkVisibility(f3_ch, p10)
print checkVisibility(f3_ch, p)
print checkVisibility(f2_ch, p)
print checkVisibility(f2_ch, p10)
# print checkVisibility(f2, p)
